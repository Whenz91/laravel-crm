<x-app-layout>
    <x-pages.header :title="'Add New Client'" :backUrl="route('client')" />
    ...
    <form action="{{ route('client.store') }}" method="post" class="max-w-full md:max-w-4xl mx-auto mt-12">
        ...
        <div class="grid grid-cols-2 gap-5">
            ...
            <div class="max-w-full mb-5">
                ...
                <input type="text" id="company_vat" name="company_vat" class="py-3 px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600" placeholder="12345678" value="{{ old('company_vat') }}">
                @error('company_vat')
                    <p class="text-red-500 mt-2">{{ $message }}</p>
                @enderror
            </div>
        ...
        <div class="grid grid-cols-2 gap-5">
            ...
            <div class="col-span-2 max-w-full mb-5">
                ...
                <input type="text" id="company_address" name="company_address" class="py-3 px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600" placeholder="M Street 145" value="{{ old('company_address') }}">
